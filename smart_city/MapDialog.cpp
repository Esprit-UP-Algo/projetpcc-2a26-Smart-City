...
MapDialog::MapDialog(QWidget *parent)
    : QDialog(parent), scaleFactor(0.3), isDragging(false)  // ← RETIREZ hoveredIncident
{
...
void MapDialog::paintEvent(QPaintEvent *event)  // ← CORRIGEZ ICI : ajoutez *event
{
