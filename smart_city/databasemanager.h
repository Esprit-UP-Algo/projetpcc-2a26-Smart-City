...
public:
    ...
    bool addHistoriqueVehicule(const QVariantMap &historique);
    QList<QVariantMap> getAllHistoriqueVehicules();
    QList<QVariantMap> getHistoriqueByVehiculeId(const QString &idVehicule);
