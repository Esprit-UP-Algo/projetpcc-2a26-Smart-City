    ...
    , ui(new Ui::FinancesPage)
{
    ...
    loadResidentCINs();   // 🔥 AJOUT IMPORTANT
...
// ----------------------------------------------------------
// CHARGER UNE TRANSACTION DANS LE FORMULAIRE
// ----------------------------------------------------------
...
bool FinancesPage::validateForm()
{
    ...
    // ❌ Plus de validation CIN ici (on supprime)
...
// ==========================================================
//  EXPORT PDF — version temporaire (juste pour compiler)
// ==========================================================
void FinancesPage::onExportPdfClicked()
{
    QMessageBox::information(this, "Export PDF", "Le système PDF fonctionne !");
}
