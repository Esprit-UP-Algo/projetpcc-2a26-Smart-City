...
"}"));
        ...
        profileFormLayout->setWidget(1, QFormLayout::ItemRole::LabelRole, roleLabel);
        ...
        profileFormLayout->setWidget(1, QFormLayout::ItemRole::FieldRole, roleLineEdit);
        ...
        profileFormLayout->setWidget(2, QFormLayout::ItemRole::LabelRole, emailLabel);
        ...
        profileFormLayout->setWidget(2, QFormLayout::ItemRole::FieldRole, emailLineEdit);
        ...
        profileFormLayout->setWidget(3, QFormLayout::ItemRole::LabelRole, phoneLabel);
        ...
        profileFormLayout->setWidget(3, QFormLayout::ItemRole::FieldRole, phoneLineEdit);
