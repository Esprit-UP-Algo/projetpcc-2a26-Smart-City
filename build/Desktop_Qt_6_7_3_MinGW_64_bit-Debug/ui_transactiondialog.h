...
public:
    ...
    void setupUi(QDialog *TransactionDialog)
    {
        ...
        formLayout->setWidget(0, QFormLayout::LabelRole, codeFieldLabel);
        ...
        formLayout->setWidget(0, QFormLayout::FieldRole, codeEdit);

        montantFieldLabel = new QLabel(TransactionDialog);
        montantFieldLabel->setObjectName("montantFieldLabel");

        formLayout->setWidget(1, QFormLayout::LabelRole, montantFieldLabel);
        ...
        formLayout->setWidget(1, QFormLayout::FieldRole, montantSpinBox);

        dateFieldLabel = new QLabel(TransactionDialog);
        dateFieldLabel->setObjectName("dateFieldLabel");

        formLayout->setWidget(2, QFormLayout::LabelRole, dateFieldLabel);
        ...
        formLayout->setWidget(3, QFormLayout::LabelRole, typeFieldLabel);
        ...
        formLayout->setWidget(3, QFormLayout::FieldRole, typeCombo);

        categorieFieldLabel = new QLabel(TransactionDialog);
        categorieFieldLabel->setObjectName("categorieFieldLabel");

        formLayout->setWidget(4, QFormLayout::LabelRole, categorieFieldLabel);
        ...
        formLayout->setWidget(4, QFormLayout::FieldRole, categorieCombo);

        modePaiementFieldLabel = new QLabel(TransactionDialog);
        modePaiementFieldLabel->setObjectName("modePaiementFieldLabel");

        formLayout->setWidget(5, QFormLayout::LabelRole, modePaiementFieldLabel);
        ...
        formLayout->setWidget(5, QFormLayout::FieldRole, modePaiementCombo);
