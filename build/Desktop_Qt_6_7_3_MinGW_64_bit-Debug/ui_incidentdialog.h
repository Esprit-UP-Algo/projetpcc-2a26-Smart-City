...
public:
    ...
    void setupUi(QDialog *IncidentDialog)
    {
        ...
        formLayout->setWidget(0, QFormLayout::LabelRole, typeFieldLabel);
        ...
        formLayout->setWidget(1, QFormLayout::LabelRole, localisationFieldLabel);
        ...
        formLayout->setWidget(1, QFormLayout::FieldRole, localisationEdit);
        ...
        formLayout->setWidget(2, QFormLayout::LabelRole, dateHeureFieldLabel);
        ...
        formLayout->setWidget(2, QFormLayout::FieldRole, dateHeureEdit);
        ...
        formLayout->setWidget(3, QFormLayout::LabelRole, graviteFieldLabel);
        ...
        formLayout->setWidget(3, QFormLayout::FieldRole, graviteSpinBox);
        ...
        formLayout->setWidget(4, QFormLayout::LabelRole, statutFieldLabel);
        ...
        formLayout->setWidget(4, QFormLayout::FieldRole, statutCombo);
