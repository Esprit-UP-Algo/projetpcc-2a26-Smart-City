...
public:
    ...
    void setupUi(QWidget *ResidentsPage)
    {
        ...
        residentsListCard->setFrameShape(QFrame::NoFrame);
        ...
        renewalLabel->setAlignment(Qt::AlignCenter);
        ...
        departureLabel->setAlignment(Qt::AlignCenter);
        ...
        incidentLabel->setAlignment(Qt::AlignCenter);
        ...
        noIncidentLabel->setAlignment(Qt::AlignCenter);
        ...
        globalScoreLabel->setAlignment(Qt::AlignCenter);
        ...
        innovativeFeaturesCard->setFrameShape(QFrame::NoFrame);
    ...
    void retranslateUi(QWidget *ResidentsPage)
    {
        ...
        searchLineEdit->setPlaceholderText(QCoreApplication::translate("ResidentsPage", "\360\237\224\215 Rechercher par nom ou CIN (insensible \303\240 la casse)", nullptr));
