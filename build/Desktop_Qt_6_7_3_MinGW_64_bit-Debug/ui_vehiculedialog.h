...
public:
    ...
    void setupUi(QDialog *VehiculeDialog)
    {
        ...
        formLayout->setWidget(0, QFormLayout::LabelRole, idFieldLabel);
        ...
        formLayout->setWidget(1, QFormLayout::LabelRole, typeFieldLabel);
        ...
        formLayout->setWidget(2, QFormLayout::LabelRole, capaciteFieldLabel);
        ...
        formLayout->setWidget(2, QFormLayout::FieldRole, capaciteSpinBox);
        ...
        formLayout->setWidget(3, QFormLayout::LabelRole, zoneFieldLabel);
        ...
        formLayout->setWidget(3, QFormLayout::FieldRole, zoneEdit);
        ...
        formLayout->setWidget(4, QFormLayout::LabelRole, horaireFieldLabel);
        ...
        formLayout->setWidget(4, QFormLayout::FieldRole, horaireEdit);
        ...
        formLayout->setWidget(5, QFormLayout::LabelRole, statutFieldLabel);
        ...
        formLayout->setWidget(5, QFormLayout::FieldRole, statutCombo);
        ...
        formLayout->setWidget(6, QFormLayout::LabelRole, kilometrageFieldLabel);
        ...
        formLayout->setWidget(6, QFormLayout::FieldRole, kilometrageSpinBox);
        ...
        formLayout->setWidget(7, QFormLayout::LabelRole, tempsFieldLabel);
        ...
        formLayout->setWidget(7, QFormLayout::FieldRole, tempsUtiliseSpinBox);
