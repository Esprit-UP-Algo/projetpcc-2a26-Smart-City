...
struct qt_meta_stringdata_CLASSLocauxPageENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSLocauxPageENDCLASS = QtMocHelpers::stringData(
    "LocauxPage",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSLocauxPageENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject LocauxPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSLocauxPageENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSLocauxPageENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLocauxPageENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<LocauxPage, std::true_type>,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_consulterButton_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void *LocauxPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSLocauxPageENDCLASS.stringdata0))
