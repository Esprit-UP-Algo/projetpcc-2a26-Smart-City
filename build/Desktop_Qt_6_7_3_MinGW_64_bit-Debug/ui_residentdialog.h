...
public:
    ...
    void setupUi(QDialog *ResidentDialog)
    {
        ...
        formLayout->setWidget(0, QFormLayout::LabelRole, cinFieldLabel);
        ...
        formLayout->setWidget(0, QFormLayout::FieldRole, cinEdit);

        nomFieldLabel = new QLabel(ResidentDialog);
        nomFieldLabel->setObjectName("nomFieldLabel");

        formLayout->setWidget(1, QFormLayout::LabelRole, nomFieldLabel);
        ...
        formLayout->setWidget(2, QFormLayout::LabelRole, prenomFieldLabel);
        ...
        formLayout->setWidget(2, QFormLayout::FieldRole, prenomEdit);

        sexeFieldLabel = new QLabel(ResidentDialog);
        sexeFieldLabel->setObjectName("sexeFieldLabel");

        formLayout->setWidget(3, QFormLayout::LabelRole, sexeFieldLabel);
        ...
        formLayout->setWidget(3, QFormLayout::FieldRole, sexeCombo);

        telephoneFieldLabel = new QLabel(ResidentDialog);
        telephoneFieldLabel->setObjectName("telephoneFieldLabel");

        formLayout->setWidget(4, QFormLayout::LabelRole, telephoneFieldLabel);
        ...
        formLayout->setWidget(4, QFormLayout::FieldRole, telephoneEdit);

        emailFieldLabel = new QLabel(ResidentDialog);
        emailFieldLabel->setObjectName("emailFieldLabel");

        formLayout->setWidget(5, QFormLayout::LabelRole, emailFieldLabel);
        ...
        formLayout->setWidget(6, QFormLayout::LabelRole, appartementFieldLabel);
        ...
        formLayout->setWidget(6, QFormLayout::FieldRole, appartementEdit);

        etageFieldLabel = new QLabel(ResidentDialog);
        etageFieldLabel->setObjectName("etageFieldLabel");

        formLayout->setWidget(7, QFormLayout::LabelRole, etageFieldLabel);
        ...
        formLayout->setWidget(7, QFormLayout::FieldRole, etageSpinBox);

        statutFieldLabel = new QLabel(ResidentDialog);
        statutFieldLabel->setObjectName("statutFieldLabel");

        formLayout->setWidget(8, QFormLayout::LabelRole, statutFieldLabel);
        ...
        formLayout->setWidget(8, QFormLayout::FieldRole, statutCombo);

        dateEntreeFieldLabel = new QLabel(ResidentDialog);
        dateEntreeFieldLabel->setObjectName("dateEntreeFieldLabel");

        formLayout->setWidget(9, QFormLayout::LabelRole, dateEntreeFieldLabel);
        ...
        formLayout->setWidget(9, QFormLayout::FieldRole, dateEntreeEdit);
